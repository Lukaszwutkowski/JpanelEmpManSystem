...
public class EmployeeInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_firstname.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_firstname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 204), 1, true));
        ...
        txt_lastname.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_lastname.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 204), 1, true));
        ...
        jComboBox_qualificaton.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"MBA", "B.TECH", "BEng", "BSc", "MSc", "PHD", " "}));
        jComboBox_qualificaton.setSelectedIndex(-1);
        ...
        // btn_imageupload.setIcon(new ImageIcon(getClass().getResource("/images/image upload.png"))); // NOI18N
        ...
        //  btn_new.setIcon(new ImageIcon(getClass().getResource("/images/new-icon.png"))); // NOI18N
        btn_new.setText("New");
        ...
        // btn_save.setIcon(new ImageIcon(getClass().getResource("/images/Save-icon.png"))); // NOI18N
        ...
        // btn_update.setIcon(new ImageIcon(getClass().getResource("/images/update.png"))); // NOI18N
        ...
        // btn_delete.setIcon(new ImageIcon(getClass().getResource("/images/delete.png"))); // NOI18N
        ...
        //  btn_clear.setIcon(new ImageIcon(getClass().getResource("/images/clear.png"))); // NOI18N
        ...
        //   btn_print.setIcon(new ImageIcon(getClass().getResource("/images/Printer-icon.png"))); // NOI18N
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        String name_validate = txt_firstname.getText();

        String age_validae = txt_age.getText();
        String bg_validate = txt_lastname.getText();
        ...
        if (name_validate.equals("")) {
            ...
            try {
                String sql = "insert into employeeinfo (FirstName,Gender,Age,LastName,ContactNo,Qualification,HireDate,Address,EmpImage)values(?,?,?,?,?,?,?,?,?)";
                pst = conn.prepareStatement(sql);
    ...
    private void Table_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_dataMouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String strname = rs.getString("FirstName");
                txt_firstname.setText(strname);
                ...
                String strbg = rs.getString("LastName");
                txt_lastname.setText(strbg);
                ...
                String dateval = rs.getString("HireDate");
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        try {
            String sql = "update employeeinfo set FirstName=?,Gender=?,Age=?,LastName=?,ContactNo=?,Qualification=?,HireDate=?,Address=?,EmpImage=? where EmployeeID=?";
            pst = conn.prepareStatement(sql);
